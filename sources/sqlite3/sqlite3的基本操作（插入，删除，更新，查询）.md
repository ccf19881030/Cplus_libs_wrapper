...
void insert_record(const char * table, int id, const char * data, const char * time)
{
	char * sql;
	char * zErrMsg = NULL;
...
void search_all(const char * table)
{
	char * sql;
	char * zErrMsg = 0;
...
void search_by_id(const char * table, char * id)
{
	char * sql;
	char * zErrMsg = 0;
...
void delete_by_id(const char * table, char * id)
{
	int rc;
	char * sql;
	char * zErrMsg = 0;
...
void delete_all(const char * table)
{
	char * sql;
	char * zErrMsg = 0;
