...
{ 
	...
	__except (code = GetExceptionCode(), CreateMiniDump(GetExceptionInformation()), EXCEPTION_EXECUTE_HANDLER)
	{
		printf("ExceptionCode:%x\n", code);

		char msg[512];
		sprintf_s(msg, "Exception happened. Exception code is %x", code);
